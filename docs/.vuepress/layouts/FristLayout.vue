          ...
          <div class="home-wrapper">
            <div class="home-slide slide-1">
              ...
              <div class="button-list">
                <img
                  class="box-shadow"
                  src="https://s1.ax1x.com/2022/11/14/zAo2nK.png"
                  alt="个人图标"
                />
            ...
            <div class="home-slide slide-2">
              <div class="left">
                <p class="slide-header">
                  <img
                    src="https://s1.ax1x.com/2022/11/14/zAocX6.png"
                    alt="icon2"
                  />写在前面
                </p>
                <p
              ...
              <div class="right">
                <img
                  ...
                  src="https://s1.ax1x.com/2022/11/14/zAoHjP.jpg"
                  alt="个人照片"
                />
              </div>
            </div>
            ...
            <div class="home-slide slide-3">
              <p class="slide-header">
                <img
                  src="https://s1.ax1x.com/2022/11/14/zAohAe.png"
                  alt="icon2"
                />自我介绍
              </p>
              <div class="slide-flex">
                ...
                <div class="blog-flex-centered img-fixed box-shadow border-radius13">
                  <img
                    class="blog-item"
                    src="https://s1.ax1x.com/2022/11/14/zAT9cq.png"
                    alt="个人照片1"
                  />
                  <div class="blog-item-content">
                    <p>喜欢跑步</p>
                ...
                <div class="blog-flex-centered img-fixed box-shadow border-radius13">
                  <img
                    class="blog-item"
                    src="https://s1.ax1x.com/2022/11/14/zATp3n.png"
                    alt="个人照片2"
                  />
                  <div class="blog-item-content">
                    <p>喜欢旅游</p>
            ...
            <div class="home-slide slide-4">
              <p class="slide-header">
                <img
                  src="https://s1.ax1x.com/2022/11/14/zAoT1I.png"
                  alt="icon2"
                />参与的项目
              </p>
            ...
            <div class="home-slide slide-5">
              ...
              <div class="slide-flex">
                <img
                  ...
                  src="https://s1.ax1x.com/2022/11/14/zAoqnf.png"
                  alt="img"
                />
                <img
                  class="img-item box-shadow border-radius13"
                  src="https://s1.ax1x.com/2022/11/14/zAoLB8.png"
                  alt="img"
                />
                <img
                  class="img-item box-shadow border-radius13"
                  src="https://s1.ax1x.com/2022/11/14/zAoOHS.png"
                  alt="img"
                />
                <img
                  class="img-item box-shadow border-radius13"
                  src="https://s1.ax1x.com/2022/11/14/zAovNQ.png"
                  alt="img"
                />
              </div>
            </div>
...
.home-box {
  ...
  .slide-1 {
    ...
    .bg {
      ...
      max-width: 100vw;
      height: 28.125rem;
      background: url(https://s1.ax1x.com/2022/11/14/zAoW7D.png) center no-repeat;
    }
    .main {
      position: absolute;
      top: 8%;
    ...
    .footer-left {
      .content-item {
        ...
        .item-icon1 {
          padding: 0.25rem;
          border-radius: 50%;
          background: url(https://s1.ax1x.com/2022/11/14/zAojAg.png)
            no-repeat center center;
        ...
        .item-icon2 {
          padding: 0.25rem;
          border-radius: 50%;
          background: url(https://s1.ax1x.com/2022/11/14/zAoxhj.png)
            no-repeat center center;
          background-color: $theme-font-color;
        }
        span {
