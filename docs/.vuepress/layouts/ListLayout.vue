...
.press-list {
  .item-data {
    &::before {
      ...
      width: 2%;
      height: 4px;
      background: var(--item-decorate-color);
    }
    &::after {
      position: absolute;
      content: '';
  ...
  .item-time {
    .time-icon {
      background: url(../public/imgs/Hc151c568f616423aa733b740fb8ee94cu.jpg) no-repeat center;
  ...
  .item-tag {
    .tag-icon {
      background: url(../public/imgs/H80b41d67c10143a1a304c5be68f7297bu.jpg) no-repeat center;
      background-size: contain;
      filter: var(--filter-invert-value);
    }
  }
